...
<head>
  ...
  <title>Forgot Password — ZedBallot</title>
  ...
  <meta property="og:title" content="Forgot Password — ZedBallot">
  <meta property="og:description" content="We will send a link to reset your password.">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <form method="POST" action="{{ url('/forgot-password') }}">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-lg btn-block" tabindex="4">Send Reset Link</button>
                  </div>
                </form>
              </div>
            </div>
